...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($db," UPDATE tbl_admissions SET img='$image', admission_lastname='$lname',admission_firstname='$fname', admission_middlename='$mname', email='$email', username='$username', password='$hashedPwd' where admission_id = '".$_SESSION['userid']."'")or die (mysqli_error($db));
    if($query == true)
    {
...
<?php 
$q = mysqli_query($db,"SELECT * from tbl_admissions where admission_id = '".$_SESSION['userid']."'")or die(mysqli_error($db));
