...
$query = mysqli_query($db,"INSERT INTO tbl_admissions(img, admission_firstname, admission_middlename, admission_lastname, activation_code, email, username, password) values ('$image', '$fname', '$mname', '$lname', '', '$email', '$username', '$hashedPwd')") or die (mysqli_error($db)); 
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <fieldset style="border: 1px solid;padding: 0px 10px;border-color: #d2d2d2">
                    ...
                    <br>
                    <button type="submit" name="submit" class="btn btn-default pull-right">Add Admission Staff</button>
