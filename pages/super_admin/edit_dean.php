...
$id =$_GET['dean_id'];
 if (isset($_POST['update'])) {
    ...
    $query = mysqli_query($db," UPDATE tbl_deans SET img='$image', dean_lastname='$lname',dean_firstname='$fname', dean_middlename='$mname', email='$email', username='$username', password='$hashedPwd' WHERE dean_id = '$id' ")or die(mysqli_error($db));
...
<?php check_message(); ?>
              <div class="card">
                <div class="card-body">
<?php 
$qwerty = mysqli_query($db,"SELECT * from tbl_deans where dean_id = '".$_GET['dean_id']."' ");
...
?>
                  ...
                  <fieldset style="border: 1px solid;padding: 0px 10px;border-color: #d2d2d2">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input name="lname" type="text" class="form-control" value="<?php echo $row['dean_lastname'] ?>">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">First Name</label>
                          <input name="fname" type="text" class="form-control" value="<?php echo $row['dean_firstname'] ?>">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Middle Name</label>
                          <input name="mname" type="text" class="form-control" value="<?php echo $row['dean_middlename'] ?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <br>
                    <button type="submit" name="update" class="btn btn-primary pull-right">Update Dean</button>
