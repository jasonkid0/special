...
$query = mysqli_query($db,"INSERT INTO tbl_admins(img, admin_lastname, admin_firstname, admin_middlename, activation_code, email, username, password) values ('$image', '$lname', '$fname', '$mname', '', '$email', '$username', '$hashedPwd')") or die (mysqli_error($db)); 
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-body">
                                                <div class="alert alert-danger">
                                                    Are you sure you want to delete <?php echo $row['admin_lastname'].', '.$row['admin_firstname'].' '.$row['admin_middlename'] ?>?
                                                </div>
                                      ...
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <a href="delete_admin.php<?php echo '?admin_id='.$id; ?>" class="btn btn-danger">Yes</a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
