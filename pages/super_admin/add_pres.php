...
$query = mysqli_query($db,"INSERT INTO tbl_presidents(pres_img, pres_lastname, pres_firstname, pres_middlename, activation_code, email, username, password) values ('$image', '$lname', '$fname', '$mname', '', '$email', '$username', '$hashedPwd')") or die (mysqli_error($db)); 
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <fieldset style="border: 1px solid;padding: 0px 10px;border-color: #d2d2d2">
                    ...
                    <br>
                    <button type="submit" name="submit" class="btn btn-default pull-right">Add President</button>
