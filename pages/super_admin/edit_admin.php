...
$id =$_GET['admin_id'];
 if (isset($_POST['update'])) {
    ...
    $query = mysqli_query($db," UPDATE tbl_admins SET img='$image', admin_lastname='$lname',admin_firstname='$fname', admin_middlename='$mname', email='$email', username='$username', password='$hashedPwd' WHERE admin_id = '$id' ")or die(mysqli_error($db));
...
?>
                  ...
                  <fieldset style="border: 1px solid;padding: 0px 10px;border-color: #d2d2d2">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input name="lname" type="text" class="form-control" value="<?php echo $row['admin_lastname'] ?>">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">First Name</label>
                          <input name="fname" type="text" class="form-control" value="<?php echo $row['admin_firstname'] ?>">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Middle Name</label>
                          <input name="mname" type="text" class="form-control" value="<?php echo $row['admin_middlename'] ?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <br>
                    <button type="submit" name="update" class="btn btn-primary pull-right">Update Admin</button>
