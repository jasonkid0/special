...
if (isset($_POST['submit'])) {
  ...
  $query = mysqli_query($db,"INSERT INTO tbl_acadyears (academic_year) values ('$department')")or die (mysqli_error($db));
    if($query == true)
    {
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <fieldset style="border: 1px solid;padding: 0px 10px;border-color: #d2d2d2">
                    <legend style="text-align:center">ADD ACADEMIC YEAR</legend>
                    <div class="row">
                    ...
                    <br>
                    <button type="submit" name="submit" class="btn btn-default pull-right">Add A.Y.</button>
