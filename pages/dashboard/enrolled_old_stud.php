...
<?php check_message(); ?>
              <div class="card">
                <div class="card-header card-header-danger">
                  <h4 class="card-title mt-0">Total No. of <b>Old Students</b>  Enrolled for A.Y <?php echo $_SESSION['active_acad'].' , '.$_SESSION['active_sem']; ?></h4>
                </div>
                <div class="card-body">
                      ...
                      <tbody>
                        <?php
                                $query = mysqli_query($db, "SELECT *,CONCAT(tbl_students.lastname, ', ', tbl_students.firstname, ' ', tbl_students.middlename)  as fullname FROM tbl_schoolyears 
                                  ...
                                  where ay_id = '$_SESSION[active_acad]' and sem_id = '$_SESSION[active_sem]' and remark= 'Approved' AND status = 'Old'") or die(mysqli_error($db));
