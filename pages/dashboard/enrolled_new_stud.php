...
<?php check_message(); ?>
              <div class="card">
                <div class="card-header card-header-danger">
                  <h4 class="card-title mt-0">Total List of <b>New Students</b>  Enrolled for A.Y <?php echo $_SESSION['active_acad'].' , '.$_SESSION['active_sem']; ?></h4>
                </div>
                <div class="card-body">
  ...
  echo'<th>OPTION</th>';
                      ...
                      <tbody>
                        <?php
                                $query = mysqli_query($db, "SELECT *,CONCAT(tbl_students.lastname, ', ', tbl_students.firstname, ' ', tbl_students.middlename)  as fullname FROM tbl_schoolyears 
                                  ...
                                  where ay_id = '$_SESSION[active_acad]' and sem_id = '$_SESSION[active_sem]' and remark= 'Approved' AND (status = 'New'||status='New-Trans')") or die(mysqli_error($db));
   ...
   ?><td>
                                    ...
                                    <i class="fa fa-check"></i> Approve</button>';}
                                      ...
                                      <a class="btn btn-danger disabled" for="DeleteAdmin" href="#delete<?php echo $id;?>" data-toggle="modal" data-target="#delete<?php echo $id;?>">
