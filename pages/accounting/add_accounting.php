...
$query = mysqli_query($db,"
  INSERT INTO tbl_accounting(img, account_lastname, account_firstname, account_middlename, activation_code, email, username, password) 
  VALUES ('$image', '$lname', '$fname', '$mname', '', '$email', '$username', '$hashedPwd')") 
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <fieldset style="border: 1px solid;padding: 0px 10px;border-color: #d2d2d2">
                    ...
                    <br>
                    <button type="submit" name="submit" class="btn btn-default pull-right">Add Accounting</button>
