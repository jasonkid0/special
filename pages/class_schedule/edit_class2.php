...
if (isset($_POST['update'])) {
  ...
  $query=mysqli_query($db," UPDATE tbl_schedules_old SET section = '$section',class_code = '$class_code', subj_id = '$subj_id',day = '$day', time = '$time',room = '$room', faculty_id = '$faculty_id', special_tut = '$special_tut' where class_id = '".$_GET['class_id']."' ") or die(mysqli_error($db));
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <fieldset style="border: 1px solid;padding: 0px 10px;border-color: #d2d2d2">
                    <legend style="text-align:center">EDIT SCHEDULE (OLD CURR)</legend><hr>
<?php 
$qwerty = mysqli_query($db,"SELECT * from tbl_schedules_old
...
LEFT JOIN tbl_faculties_staff ON tbl_faculties_staff.faculty_id = tbl_schedules_old.faculty_id where class_id = '".$_GET['class_id']."' ");
