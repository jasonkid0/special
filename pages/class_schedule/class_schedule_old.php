...
<?php if ($_SESSION['department'] == 'EDUC Department') {
  echo '     <div class="card">
                <div class="card-header card-header-tabs card-header-primary">
                  <h4 class="card-title mt-0">Class Schedule for '.$_SESSION['active_sem'].' A.Y '.$_SESSION['active_acad'].'&nbsp;&nbsp;(Old Curriculum)</h4>
                  <div class="nav-tabs-navigation">
                    <div class="nav-tabs-wrapper">
                      <span class="nav-tabs-title">Course:</span>
                      <ul class="nav nav-tabs" data-tabs="tabs">
                        <li class="nav-item">
                          <a class="nav-link active" href="#eced" data-toggle="tab">
                        ...
                        <li class="nav-item">
                          <a class="nav-link" href="#fili" data-toggle="tab">
                            <i class="material-icons">cloud</i> BSED-FILI
                            <div class="ripple-container"></div>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="#engl" data-toggle="tab">
                            <i class="material-icons">cloud</i> BSED-ENGL
                            <div class="ripple-container"></div>
                          </a>
                        </li>
                      </ul>';
                      ...
                      <ul class="nav nav-tabs" data-tabs="tabs">
                        <li class="nav-item">
                          <a class="nav-link active" href="#bamrkt" data-toggle="tab">
                            <i class="material-icons">bug_report</i> BSBA - Marketing
                            <div class="ripple-container"></div>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="#bamngt" data-toggle="tab">
                            <i class="material-icons">bug_report</i> BSBA - Management
                            <div class="ripple-container"></div>
                          </a>
                        </li>
                      </ul>';
                      ...
                      <ul class="nav nav-tabs" data-tabs="tabs">
                        <li class="nav-item">
                          <a class="nav-link active" href="#hrm" data-toggle="tab">
                            <i class="material-icons">bug_report</i> BSHRM
                            <div class="ripple-container"></div>
                          </a>
                        </li>
                      </ul>';
...
<?php if ($_SESSION['department'] == 'EDUC Department'){ ?>
                    <div class="tab-pane active" id="eced">
                      ...
                      <tbody>
                        <?php 
                                $query1 = mysqli_query($db, "
                                  SELECT *,CONCAT(tbl_faculties_staff.faculty_lastname, ', ', tbl_faculties_staff.faculty_firstname, ' ', tbl_faculties_staff.faculty_middlename)  as fullname,
                                  tbl_courses.course_id, 
                                  tbl_subjects.subj_id, 
                                  tbl_departments.department_id, 
                                  tbl_year_levels.year_id, 
                                  tbl_semesters.sem_id, 
                                  tbl_faculties_staff.faculty_id 
                                  ...
                                  LEFT JOIN tbl_faculties_staff ON tbl_faculties_staff.faculty_id = tbl_schedules_old.faculty_id where tbl_departments.department_name = '$_SESSION[department]' and tbl_courses.course_id = '13' AND tbl_schedules_old.acad_year = '$_SESSION[active_acad]' AND tbl_schedules_old.semester = '$_SESSION[active_sem]'");
                                while ($row1= mysqli_fetch_array($query1)){
                                    ...
                                    <td>
                                      <a class="btn btn-primary" for="ViewAdmin" href="edit_class2.php<?php echo '?class_id='.$id; ?>">
                                      ...
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <a href="delete_class2.php<?php echo '?class_id='.$id; ?>" class="btn btn-danger">Yes</a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                    ...
                    <div class="tab-pane" id="math">
                      ...
                      <tbody>
                        <?php 
                                $query2 = mysqli_query($db, "SELECT *,CONCAT(tbl_faculties_staff.faculty_lastname, ', ', tbl_faculties_staff.faculty_firstname, ' ', tbl_faculties_staff.faculty_middlename)  as fullname,
                                  tbl_courses.course_id, 
                                  tbl_subjects.subj_id, 
                                  tbl_departments.department_id, 
                                  tbl_year_levels.year_id, 
                                  ...
                                  LEFT JOIN tbl_year_levels ON tbl_year_levels.year_id = tbl_subjects.year_id
                                  LEFT JOIN tbl_semesters ON tbl_semesters.sem_id = tbl_subjects.sem_id
                                  LEFT JOIN tbl_faculties_staff ON tbl_faculties_staff.faculty_id = tbl_schedules_old.faculty_id where tbl_departments.department_name = '$_SESSION[department]' and tbl_courses.course_id = '12' AND tbl_schedules_old.acad_year = '$_SESSION[active_acad]' AND tbl_schedules_old.semester = '$_SESSION[active_sem]'");
                    ...
                    <div class="tab-pane" id="fili">
                      ...
                      <tbody>
                        <?php 
                                $query3 = mysqli_query($db, "SELECT *,CONCAT(tbl_faculties_staff.faculty_lastname, ', ', tbl_faculties_staff.faculty_firstname, ' ', tbl_faculties_staff.faculty_middlename)  as fullname, 
                                  tbl_courses.course_id, 
                                  tbl_subjects.subj_id, 
                                  tbl_departments.department_id, 
                                  tbl_year_levels.year_id, 
                                  ...
                                  LEFT JOIN tbl_departments on tbl_departments.department_id = tbl_courses.department_id
                                  LEFT JOIN tbl_year_levels ON tbl_year_levels.year_id = tbl_subjects.year_id
                                  LEFT JOIN tbl_faculties_staff ON tbl_faculties_staff.faculty_id = tbl_schedules_old.faculty_id where tbl_departments.department_name = '$_SESSION[department]' and tbl_courses.course_id = '11' AND tbl_schedules_old.acad_year = '$_SESSION[active_acad]' AND tbl_schedules_old.semester = '$_SESSION[active_sem]'");
                      ...
                      <tbody>
                        <?php 
                                $query3 = mysqli_query($db, "SELECT *,CONCAT(tbl_faculties_staff.faculty_lastname, ', ', tbl_faculties_staff.faculty_firstname, ' ', tbl_faculties_staff.faculty_middlename)  as fullname, 
                                  ...
                                  LEFT JOIN tbl_departments on tbl_departments.department_id = tbl_courses.department_id
                                  LEFT JOIN tbl_year_levels ON tbl_year_levels.year_id = tbl_subjects.year_id
                                  LEFT JOIN tbl_faculties_staff ON tbl_faculties_staff.faculty_id = tbl_schedules_old.faculty_id where tbl_departments.department_name = '$_SESSION[department]' and tbl_courses.course_id = '10' AND tbl_schedules_old.acad_year = '$_SESSION[active_acad]' AND tbl_schedules_old.semester = '$_SESSION[active_sem]'");
                                while ($row3= mysqli_fetch_array($query3)){
                                    $id=$row3['class_id'];
                                    ?><tr>
                                    <td><?php echo $row3['section']; ?></td>
                      ...
                      <tbody>
                        <?php 
                                $query4 = mysqli_query($db, "
                                  ...
                                  LEFT JOIN tbl_year_levels ON tbl_year_levels.year_id = tbl_subjects.year_id
                                  LEFT JOIN tbl_semesters ON tbl_semesters.sem_id = tbl_subjects.sem_id
                                  LEFT JOIN tbl_faculties_staff ON tbl_faculties_staff.faculty_id = tbl_schedules_old.faculty_id where tbl_departments.department_name = '$_SESSION[department]' and tbl_courses.course_id = '1' AND tbl_schedules_old.acad_year = '$_SESSION[active_acad]' AND tbl_schedules_old.semester = '$_SESSION[active_sem]'")or die(mysqli_error($db));
                      ...
                      <tbody>
                        <?php 
                                $query5 = mysqli_query($db, "
                                  ...
                                  LEFT JOIN tbl_year_levels ON tbl_year_levels.year_id = tbl_subjects.year_id
                                  LEFT JOIN tbl_semesters ON tbl_semesters.sem_id = tbl_subjects.sem_id
                                  LEFT JOIN tbl_faculties_staff ON tbl_faculties_staff.faculty_id = tbl_schedules_old.faculty_id where tbl_departments.department_name = '$_SESSION[department]' and tbl_courses.course_id = '2' AND tbl_schedules_old.acad_year = '$_SESSION[active_acad]' AND tbl_schedules_old.semester = '$_SESSION[active_sem]'");
...
<?php }elseif ($_SESSION['department'] == 'BA Department') { ?>
                    <div class="tab-pane active" id="bamrkt">
                      ...
                      <tbody>
                        <?php 
                                $query6 = mysqli_query($db, "SELECT *,CONCAT(tbl_faculties_staff.faculty_lastname, ', ', tbl_faculties_staff.faculty_firstname, ' ', tbl_faculties_staff.faculty_middlename)  as fullname,
                                  tbl_courses.course_id, 
                                  tbl_subjects.subj_id, 
                                  tbl_departments.department_id, 
                                  tbl_year_levels.year_id, 
                                  ...
                                  LEFT JOIN tbl_year_levels ON tbl_year_levels.year_id = tbl_subjects.year_id
                                  LEFT JOIN tbl_semesters ON tbl_semesters.sem_id = tbl_subjects.sem_id
                                  LEFT JOIN tbl_faculties_staff ON tbl_faculties_staff.faculty_id = tbl_schedules_old.faculty_id where tbl_departments.department_name = '$_SESSION[department]' and tbl_courses.course_id = '3' AND tbl_schedules_old.acad_year = '$_SESSION[active_acad]' AND tbl_schedules_old.semester = '$_SESSION[active_sem]'");
                    ...
                    <div class="tab-pane" id="bamngt">
                      ...
                      <tbody>
                        <?php 
                                $query7 = mysqli_query($db, "SELECT *,CONCAT(tbl_faculties_staff.faculty_lastname, ', ', tbl_faculties_staff.faculty_firstname, ' ', tbl_faculties_staff.faculty_middlename)  as fullname,
                                  tbl_courses.course_id, 
                                  tbl_subjects.subj_id, 
                                  tbl_departments.department_id, 
                                  tbl_year_levels.year_id, 
                                  ...
                                  LEFT JOIN tbl_year_levels ON tbl_year_levels.year_id = tbl_subjects.year_id
                                  LEFT JOIN tbl_semesters ON tbl_semesters.sem_id = tbl_subjects.sem_id
                                  LEFT JOIN tbl_faculties_staff ON tbl_faculties_staff.faculty_id = tbl_schedules_old.faculty_id where tbl_departments.department_name = '$_SESSION[department]' and tbl_courses.course_id = '14' AND tbl_schedules_old.acad_year = '$_SESSION[active_acad]' AND tbl_schedules_old.semester = '$_SESSION[active_sem]'");
                      ...
                      <tbody>
                        <?php 
                                $query8 = mysqli_query($db, "
                                  ...
                                  LEFT JOIN tbl_year_levels ON tbl_year_levels.year_id = tbl_subjects.year_id
                                  LEFT JOIN tbl_semesters ON tbl_semesters.sem_id = tbl_subjects.sem_id
                                  LEFT JOIN tbl_faculties_staff ON tbl_faculties_staff.faculty_id = tbl_schedules_old.faculty_id where tbl_departments.department_name = '$_SESSION[department]' and tbl_courses.course_id = '8' AND tbl_schedules_old.acad_year = '$_SESSION[active_acad]' AND tbl_schedules_old.semester = '$_SESSION[active_sem]'");
