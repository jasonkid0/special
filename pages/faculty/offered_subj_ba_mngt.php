...
$q = mysqli_query($db,"SELECT *, tbl_semesters.sem_id,tbl_year_levels.year_id,tbl_courses.course_id,tbl_courses.department_id,tbl_departments.department_id FROM tbl_subjects_new
      ...
      LEFT JOIN tbl_year_levels ON tbl_year_levels.year_id = tbl_subjects_new.year_id where tbl_departments.department_name = '$_SESSION[department]' and tbl_courses.course_id = '25' and tbl_semesters.semester = '$_SESSION[active_sem]' ORDER BY tbl_year_levels.year_level, tbl_semesters.semester") or die(mysqli_error($db));
