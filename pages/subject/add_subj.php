...
if (isset($_POST['submit'])) {
  ...
  $chk = mysqli_query($db,"SELECT *, tbl_courses.course_id FROM tbl_subjects LEFT JOIN tbl_courses ON tbl_courses.course_id = tbl_subjects.course_id where subj_code = '$subj_code' AND subj_desc = '$subj_desc' AND course = '$course'");
...
<?php check_message(); ?>
              <div class="card">
                <div class="card-header card-header-danger">
                    <h4 class="card-title">Add Subject (Old Curriculum)</h4>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input name="prereq" type="text" class="form-control" required="required">
                        </div>
                      </div>
                    </div>
                    <div class="row">
